...
class FinancialBot:
    def __init__(self):
        ...
        self.house_expenses = 1
        self.entertainment_expenses = 1
    def greet_user():
        return "Welcome to the Financial Bot!"
    ...
    def ask_total_income(self,message):
        prompts = [
        ...
        self.total_income = message 
        return income_prompt
        

    def ask_total_expenses(self,message):
        prompts = [
        ...
        self.total_expenses = int(message)
        return expenses_prompt
        

    def ask_house_expenses(self,message):
        prompts = [
    ...
    def congratulate_user(self):
        congratulations = [
            ...
            "Kudos to you for your prudent budgeting! By keeping your expenditure on entertainment and miscellaneous purposes below 30% of your total expenditure, you're demonstrating excellent financial stewardship.",
